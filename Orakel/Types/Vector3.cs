...
namespace Orakel
{
    public struct Vector3
    {
        ...
        /// <param name="other"></param>
        /// <returns></returns>
        public bool IsParallelWith(Vector3 other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            else if (obj is BulletSharp.Math.Vector3)
            {
                x = ((BulletSharp.Math.Vector3)obj).X;
                y = ((BulletSharp.Math.Vector3)obj).Y;
                z = ((BulletSharp.Math.Vector3)obj).Z;
            }
            else
                return false;
        ...
        public static implicit operator BulletSharp.Math.Vector3(Vector3 other)
        {
            return new BulletSharp.Math.Vector3(other.X, other.Y, other.Z);
        }
        ...
        public static implicit operator Vector3(BulletSharp.Math.Vector3 other)
        {
